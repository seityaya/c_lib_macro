...
UT_FUNC_GEN(test_arithmetic_compare) {
    UT_GROUP_BEG(compare) {
        UT_GROUP_BEG(eq) {
            ...
            UT_ASSERT_BOOL_TRUE(eq( 1.0, 1.0));
        }UT_GROUP_END;

        UT_GROUP_BEG(nq) {
            UT_ASSERT_BOOL_TRUE(nq(  1,   2));
            UT_ASSERT_BOOL_TRUE(nq(1.0, 2.0));
        }UT_GROUP_END;

        UT_GROUP_BEG(gt) {
            UT_ASSERT_BOOL_TRUE(gt(  2,   1));
            UT_ASSERT_BOOL_TRUE(gt(2.0, 1.0));
        }UT_GROUP_END;

        UT_GROUP_BEG(lt) {
            UT_ASSERT_BOOL_TRUE(lt(  1,   2));
            UT_ASSERT_BOOL_TRUE(lt(1.0, 2.0));
        }UT_GROUP_END;
        ...
        UT_GROUP_BEG(ge) {
            ...
            UT_ASSERT_BOOL_TRUE(ge(2.0, 1.0));
            UT_ASSERT_BOOL_TRUE(ge(2.0, 2.0));
        }UT_GROUP_END;
        ...
        UT_GROUP_BEG(le) {
            ...
            UT_ASSERT_BOOL_TRUE(le(1.0, 2.0));
            UT_ASSERT_BOOL_TRUE(le(1.0, 1.0));
        }UT_GROUP_END;
        ...
        UT_GROUP_BEG(ap) {
            ...
            UT_ASSERT_BOOL_TRUE(ap(   1.0,   1.0,  0.0));
            UT_ASSERT_BOOL_TRUE(ap(   9.0,  10.0,  1.0));
            UT_ASSERT_BOOL_TRUE(ap(  90.0, 100.0, 10.0));
            UT_ASSERT_BOOL_TRUE(ap(-100.0, -90.0, 10.0));

            UT_ASSERT_BOOL_FALSE(ap(  1.0,   2.0,  0.0));
            UT_ASSERT_BOOL_FALSE(ap(100.0, -90.0, 10.0));
        }UT_GROUP_END;
    }UT_GROUP_END;
}
